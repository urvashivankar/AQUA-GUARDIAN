...
async def add_discussion(
    ...
    photo_url = None
    if file:
        if message_type not in ["PROOF_UPLOAD", "CLARIFICATION", "FIELD_UPDATE", "CLOSURE_NOTE", "STATUS_UPDATE"]:
             raise HTTPException(status_code=400, detail="Attachments only allowed for PROOF_UPLOAD, CLARIFICATION, FIELD_UPDATE, CLOSURE_NOTE or STATUS_UPDATE")
